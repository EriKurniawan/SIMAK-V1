    ...
    $.extend(KeyTable.prototype, {
        ...
        _constructor: function () {
            ...
            if (this.c.blurable) {
                $(document).on("mousedown" + namespace, function (e) {
                    ...
                    // if ( $(e.target).parents( '.' ).length ) {
                    // 	that._blur();
                    // }

                    // If the click was inside the DataTables container, don't blur
                    if (
                        $(e.target).parents().filter(dt.table().container())
                            .length
                    ) {
                        return;
                    }
            ...
            var editInline = function () {
                ...
                editor
                    .one("open" + namespace, function () {
                        ...
                        dt.keys.enable(
                            hardEdit ? "tab-only" : "navigation-only"
                        );
                        ...
                        editor.one("close" + namespace, function () {
                            ...
                            $(dt.table().container()).removeClass(
                                "dtk-focus-alt"
                            );
        ...
        _focus: function (row, column, shift, originalEvent) {
            ...
            if (
                pageInfo.length !== -1 &&
                (row < pageInfo.start ||
                    row >= pageInfo.start + pageInfo.length)
            ) {
        ...
        _updateFixedColumns: function (column) {
            ...
            if (settings._oFixedColumns) {
                ...
                var rightCols =
                    settings.aoColumns.length -
                    settings._oFixedColumns.s.iRightColumns;
