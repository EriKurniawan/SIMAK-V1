...
(function (c) {
    ...
    c.extend(t.prototype, {
        ...
        _constructor: function () {
            ...
            if (this.c.blurable)
                c(k).on("mousedown" + d, function (g) {
                    c(g.target).parents(".").length && a._blur();
                    c(g.target).parents().filter(b.table().container())
                        .length ||
        ...
        _blur: function (a) {
            if (this.s.enable && this.s.lastFocus) {
                ...
                a ||
                    (this._updateFixedColumns(b.index().column),
                    this._emitEvent("key-blur", [this.s.dt, b]));
            }
        },
        _clipboard: function () {
            var a = this.s.dt,
                ...
                (c(k).on("copy" + e, function (d) {
                    ...
                    !f &&
                        ...
                        (d.clipboardData.setData(
                            "text/plain",
                            p.cell.render(b.c.clipboardOrthogonal)
                        ),
                        d.preventDefault());
                }),
                    ...
                    !p ||
                        ...
                        d
                            ? ((f = b._inlineOptions(p.cell.index())),
                              d
                                  .inline(f.cell, f.field, f.options)
                                  .set(d.displayed()[0], g)
                                  .submit())
                    ...
                    var q = function () {
                        ...
                        p.one("open" + g, function () {
                            ...
                            p.one("close" + g, function () {
                                ...
                                p.off(g);
                                c(f.table().container()).removeClass(
                                    "dtk-focus-alt"
                                );
                                d.s.returnSubmit &&
                                    ((d.s.returnSubmit = !1),
                                    d._emitEvent("key-return-submit", [f, l]));
                            });
                        })
        ...
        _inlineOptions: function (a) {
            return this.c.editorOptions
                ? this.c.editorOptions(a)
                : { cell: a, field: m, options: m };
        },
                ...
                if (
                    ...
                    if (d)
                        if (this.s.dt.cell(d.node).any()) {
                            d = this.s.dt;
                            var f = this.s.dt.settings()[0].oScroll.sY
                                ? !0
                                : !1;
                            if (
                                !this.c.keys ||
                                -1 !== c.inArray(a.keyCode, this.c.keys)
                            )
                                switch (a.keyCode) {
                                    case 9:
                                        this._shift(
        ...
        _scroll: function (a, b, e, d) {
            ...
            a = a.width();
            "position" === d &&
                (f.top += parseInt(e.closest("table").css("top"), 10));
    ...
    n.ext.selector.cell.push(function (a, b, e) {
        ...
        for (var f = 0, p = e.length; f < p; f++)
            ((!0 === b && a.focused(e[f])) || (!1 === b && !a.focused(e[f]))) &&
                d.push(e[f]);
        return d;
    });
